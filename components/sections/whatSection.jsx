  ...
  return (
    <div class="main">
        <div id="cont">
            ...
            <p id="txt">For P2E gamers who want to identify and play games<br/> with the highest yields, Respct is a platform that enables<br/> permissionless entry into different games with 1 click,<br/> unlike guilds which take 7-12 days to onboard gamers.<br/> retention in games.
        ...
        <div class="controller">
            <img src="../images/tri.png" onclick={() =>fadeOut()} class="im"/>
            <img src="../images/circle.png" onclick={() =>fadeIn()} class="im"/>
            <img src="../images/square.png" class="im" onclick={() =>fade()}/>
            <img src="../images/cross.png" class="im"/>
          </div>
      </div>
  );
}
