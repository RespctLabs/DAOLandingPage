...
function setSsgStaticAssetExpiration(builder, prerenderManifest, distDir) {
    for (let [path, entry] of Object.entries(prerenderManifest.routes)) {
        ...
        if (initialRevalidateSeconds) {
            builder
                .setStaticAssetExpiration(`${distDir}/pages${path}.html`, initialRevalidateSeconds, initialRevalidateSeconds // temporary fix to pass build
            )
                .setStaticAssetExpiration(`${distDir}/pages${path}.json`, initialRevalidateSeconds, initialRevalidateSeconds // temporary fix to pass build
            );
        }
    }
}
