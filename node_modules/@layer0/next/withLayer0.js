...
module.exports = function withLayer0(_nextConfig) {
    const normalizedNextConfig = typeof _nextConfig === 'function' ? _nextConfig : () => _nextConfig || {};
    const plugin = (...args) => {
        const nextConfig = normalizedNextConfig(...args);
        const { useServerBuild } = getServerBuildAvailability_1.getServerBuildAvailability({ config: nextConfig });
        return {
            ...nextConfig,
