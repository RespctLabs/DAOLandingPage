...
class DeploymentBuilder {
    ...
    async build(options) {
        ...
        for (let destination in edgeConfig.destinations) {
            ...
            routes
                ...
                (_b = (_a = r.route) === null || _a === void 0 ? void 0 : _a.fsPath) === null || _b === void 0 ? void 0 : _b.forEach(fsPath => {
                    // @ts-ignore - not happy with r.route potentially undefined here
                    const { fsExclude: exclude, backend } = r.route;
                    ...
                    this.addStaticAsset(path_1.join(this.appDir, relativePath), relativePath, {
                        permanent,
                        exclude,
                    });
                });
        ...
        if (!isEmpty_1.default(this.assetAliases)) {
            ...
            this.writeFileSync(path_1.join(this.layer0Dir, constants_1.LAYER0_ASSET_ALIASES_FILE), JSON.stringify(this.assetAliases, null, '  '));
            process.stdout.write('done.\n');
        }
    ...
    async includeNodeModules() {
        if (config_1.default.get('includeNodeModules', false) === true) {
            ...
            await this.exec(`${cmd} ${args.join(' ')}`, { cwd: this.jsDir });
            process.stdout.write('done.\n');
        }
    }
    /**
    ...
    writeStaticAssetExpiration() {
        this.writeFileSync(path_1.join(this.layer0Dir, 'static-asset-expiration.json'), JSON.stringify(this.assetExpiration));
    }
}
